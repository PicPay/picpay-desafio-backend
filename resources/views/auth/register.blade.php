            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('register') }}">
                        ...
                        <div class="form-group row">
                            <label for="user_type_id" class="col-md-4 col-form-label text-md-right">{{ __('Tipo de usuário') }}</label>

                            <div class="col-md-6">
                                <select id="user_type_id" class="form-control @error('user_type_id') is-invalid @enderror" name="user_type_id" required autocomplete="user_type_id">
                        ...
                        <div class="form-group row">
                            <label for="document" class="col-md-4 col-form-label text-md-right">{{ __('CPF/CNPJ') }}</label>
